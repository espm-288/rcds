...
- You will need to bring a laptop to class.  Please contact me if this will be an issue.

- Have RStudio, the `tidyverse` R package, and git installed before class. Contact myself or the GSI with any issues.

- Also, you will need to register for a (free) account at GitHub.com, and let us know your GitHub username [here](https://docs.google.com/a/berkeley.edu/forms/d/e/1FAIpQLScGfha3l_l8sBRgOILbEflGlChOOqvg44sXOa5ZVgsbRPMpIg/viewform) (Berkeley login required).
