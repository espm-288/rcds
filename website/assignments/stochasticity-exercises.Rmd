...
These exercises provide a continuation from the [multi-species population dynamics exercises](/assignments/popdyn-assignment)

## Exercise 1: Environmental noise

1. Run multiple replicates of the simulation with logistic growth [shown in class](/lectures/stochasticity-lecture) (leaving the parameters fixed) and plot the results.
